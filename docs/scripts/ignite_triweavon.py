...
def start_site_server():
    ...
    site_candidates = [
        r"F:\Users\Matthew Ruhnau\coherence-mcp\coherence-site\public",
        r"F:\Users\Matthew Ruhnau\LogOS\crates\coherence-mcp\coherence-site\public",
    ]
    PORT = 8080
    ...
    for site_dir in site_candidates:
        ...
        with socketserver.TCPServer(("", PORT), Handler) as httpd:
            ...
            httpd.serve_forever()
    raise FileNotFoundError("coherence-site/public not found in canonical paths")

def start_gear_core():
    print("[*] Igniting GEAR Core Telemetry (ws://127.0.0.1:8089)...")
    try:
        subprocess.Popen(["python", "gear_core.py"], cwd=r"F:\Users\Matthew Ruhnau\LogOS")
...
def main():
    ...
    mcp_dir = r"F:\Users\Matthew Ruhnau\coherence-mcp"
    if not os.path.exists(mcp_dir):
        mcp_dir = r"F:\Users\Matthew Ruhnau\LogOS\crates\coherence-mcp"
