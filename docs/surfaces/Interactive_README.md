...
Shell entry: `logos-site` / `logos-surfaces` (registry: `ops/command-surface.json`).

- [**Meta-Map**](../../coherence-mcp/coherence-site/public/meta-map/) — sovereign command-surface hub (`logos-site`)
- [**RUST Market**](../../coherence-mcp/coherence-site/public/RUST_Market/) — crate certification map (`logos-site rust-market`)
- [Orchestrator](orchestrator.html) — multi-strand live board
- [Reforge](reforge/) — Ithildin reading / live state
- [Evenstar](evenstar.html) — Evenstar surface
- [Gate](../../coherence-mcp/coherence-site/public/gate/) — SPHINX gate
- [OS](../../coherence-mcp/coherence-site/public/os) — Primary Operating System interface overlay
- [MCP Cockpit](../../stitch/coherence_mcp_cockpit/code.html) — stitch control panel

### TUI / MCP (shell)

| Cmd | Surface |
|-----|---------|
| `logos-mcp` | coherence-mcp tools |
| `logos-bridge` + `logos-tui` | reson8-forge (reson8-tui) |
| `logos-barcode` | barcode-tui PH viewer |
